      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">StockPredict</h3>
            <p className="text-blue-200 text-sm">
              Empowering investors with AI-driven stock predictions and market insights.
            </p>
          </div>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 transition duration-300">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-8 pt-8 border-t border-blue-500 text-center text-sm text-blue-200">
